...
We would ❤️ for you to contribute to CN Project and help make it better! All contributions are welcome, including issues, suggestions, pull requests and more.
...
1. Create a fork of the repository by clicking on the `Fork` button in the CN Project repository

2. Clone your fork to your machine with `git clone`

```
$ git clone https://github.com/[your_username]/CN-Project-share
```
...
CN Project consists of a frontend and a backend.
