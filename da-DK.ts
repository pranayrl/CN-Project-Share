export default {
  ...
  "home.bullet.a.description": "Host CN Project på din egen maskine.",
  ...
  "admin.config.config-file-warning.description": "As you have a configured CN Project with a configuration file, you can't change the configuration through the UI.",
  ...
  "admin.config.general.app-url.description": "På hvilken URL CN Project er tilgængelig",
  ...
  "admin.config.cache.redis-enabled.description": "Normally CN Project caches information in memory. If you run multiple instances of CN Project, you need to enable Redis caching to share the cache between the instances.",
